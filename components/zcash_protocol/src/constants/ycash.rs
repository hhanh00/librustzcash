...
/// The HRP for a Bech32-encoded Ycash main network Sapling
/// [`ExtendedSpendingKey`].
///
/// Defined in [ZIP 32].
///
...
/// The prefix for a Base58Check-encoded Ycash main network Sprout address.
///
...
/// The prefix for a Base58Check-encoded DER-encoded Ycash main network [`SecretKey`].
///
/// [`SecretKey`]: https://docs.rs/secp256k1/latest/secp256k1/struct.SecretKey.html
pub const B58_SECRET_KEY_PREFIX: [u8; 1] = [0x80];

/// The prefix for a Base58Check-encoded Ycash main network [`PublicKeyHash`].
///
...
/// The prefix for a Base58Check-encoded Ycash main network [`ScriptHash`].
///
...
/// The HRP for a Bech32m-encoded Ycash main network [ZIP 320] TEX address.
///
/// [ZIP 320]: https://zips.z.cash/zip-0320
pub const HRP_TEX_ADDRESS: &str = "tex";

/// The HRP for a Bech32m-encoded Ycash main network Unified Address.
///
...
/// The HRP for a Bech32m-encoded Ycash main network Unified FVK.
///
/// Defined in [ZIP 316][zip-0316].
///
/// [zip-0316]: https://zips.z.cash/zip-0316
...
/// The HRP for a Bech32m-encoded Ycash main network Unified IVK.
///
/// Defined in [ZIP 316][zip-0316].
///
/// [zip-0316]: https://zips.z.cash/zip-0316
