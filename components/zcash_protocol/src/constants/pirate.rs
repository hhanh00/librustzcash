...
/// The Pirate Chain coin type for ARRR, as defined by [SLIP 44].
///
/// [SLIP 44]: https://github.com/satoshilabs/slips/blob/master/slip-0044.md
pub const COIN_TYPE: u32 = 141;

/// The HRP for a Bech32-encoded Pirate Chain Sapling
/// [`ExtendedSpendingKey`].
///
/// Defined in [ZIP 32].
///
...
/// The prefix for a Base58Check-encoded Pirate Chain Sprout address.
///
...
/// The prefix for a Base58Check-encoded DER-encoded Pirate Chain [`SecretKey`].
///
/// [`SecretKey`]: https://docs.rs/secp256k1/latest/secp256k1/struct.SecretKey.html
pub const B58_SECRET_KEY_PREFIX: [u8; 1] = [0x80];

/// The prefix for a Base58Check-encoded Pirate Chain [`PublicKeyHash`].
///
...
/// The prefix for a Base58Check-encoded Pirate Chain [`ScriptHash`].
///
...
/// The HRP for a Bech32m-encoded Pirate Chain [ZIP 320] TEX address.
///
/// [ZIP 320]: https://zips.z.cash/zip-0320
pub const HRP_TEX_ADDRESS: &str = "tex";

/// The HRP for a Bech32m-encoded Pirate Chain Unified Address.
///
...
/// The HRP for a Bech32m-encoded Pirate Chain Unified FVK.
///
/// Defined in [ZIP 316][zip-0316].
///
/// [zip-0316]: https://zips.z.cash/zip-0316
...
/// The HRP for a Bech32m-encoded Pirate Chain Unified IVK.
///
/// Defined in [ZIP 316][zip-0316].
///
/// [zip-0316]: https://zips.z.cash/zip-0316
